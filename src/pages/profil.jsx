      ...
      <div className="mt-20 m-10 rounded-2xl p-10">
        <div className="container mx-auto grid grid-cols-12 gap-10 w-full py-10">
          ...
          <div className="col-span-12 md:col-span-8 md:p-15 p-10 justify-center w-full h-full align-middle">
            <p className="text-justify text-black text-2xl mt-20">“Setiap tetes darah yang kamu berikan adalah tanda cinta dan kepedulianmu terhadap sesama. Mari berbagi kebaikan dengan donor darah dan berbagi pengalaman mu”</p>
          </div>
        </div>
      </div>
          ...
          <div className="flex gap-20">
            <div className="flex flex-col justify-start">
              <div className="h-62 w-62 rounded-lg flex flex-col justify-center items-center gap-2">
                <h3 className="font-bold text-xl " onClick={handleCancelPasswordChange}>
                  Akun
                </h3>
            ...
            {isChangingPassword ? (
              <div className="col-span-12  flex flex-col justify-center gap-1">
                ...
                <input type="email" id="email" value={email} onChange={handleEmail} className="border border-solid border-gray-300 rounded-md p-2 mb-4" />
              ...
              <div className="flex flex-col justify-center gap-1">
                ...
                <div className="grid grid-cols-12 mt-2">
                  <p className="text-lg font-normal col-span-3 ml-3">Tanggal Lahir</p>
                  <p className="text-lg font-normal col-span-9 ml-3 text-end">{usersData.tanggal_lahir || "null"}</p>
                </div>
                <img src={line} alt="" className="col-span-12 text-xs" />
                <div className="grid grid-cols-12 mt-2">
                  <p className="text-lg font-normal col-span-3 ml-3">Jenis Kelamin</p>
                  <p className="text-lg font-normal col-span-9 ml-3 text-end">{usersData.jk || "null"}</p>
                </div>
                <img src={line} alt="" className="col-span-12" />
                <div className="grid grid-cols-12 mt-2">
                  <p className="text-lg font-normal col-span-3 ml-3">NIK</p>
                  <p className="text-lg font-normal col-span-9 ml-3 text-end">{usersData.nik || "null"}</p>
                </div>
                <img src={line} alt="" className="col-span-12" />
                <div className="grid grid-cols-12 mt-2">
                  <p className="text-lg font-normal col-span-3 ml-3">Alamat</p>
                  <p className="text-lg font-normal col-span-9 ml-3 text-end">{usersData.alamat || "null"}</p>
                </div>
                <img src={line} alt="" className="col-span-12" />
                <div className="grid grid-cols-12 mt-2">
                  <p className="text-lg font-normal col-span-3 ml-3">Nama Pengguna</p>
                  <p className="text-lg font-normal col-span-9 ml-3 text-end">{usersData.username || "null"}</p>
                </div>
                <img src={line} alt="" className="col-span-12" />
              </div>
            )}
