...
import { GoldarEditData } from "../../../controllers/GolonganDarahData";
      ...
      <LayoutAdmin>
        <div className="h-full ml-14 mt-14 mb-10 md:ml-64">
          ...
          <section className="p-8 ">
            <h1 className="pb-3 font-semibold text-xl text-gray-900">Edit Golongan Darah</h1>
